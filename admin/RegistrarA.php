...
<body>
    ...
    <div class="register-page">
        <div class="register-container">
            ...
            <form action="registroadmin.php" method="POST" class="register-form">
            ...
            <script>
                // Mostrar u ocultar campos de estudiante según selección
                document.getElementById("tipo_usuario").addEventListener("change", function () {
                    let camposEstudiante = document.getElementById("campos_estudiante");
